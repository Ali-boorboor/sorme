...
const LoginPage = memo(() => {
  return (
    <form
      className="bg-primary-color pt-8 py-4 px-6 rounded-2xl flex flex-col gap-4 max-w-md m-auto w-full"
    ...
    >
      ...
      <p className="font-semibold text-white text-xl text-center">Enter username and password</p>
      <section className="">
      ...
      <section className="flex justify-between items-center">
        ...
        <Link
          ...
          className="font-bold text-lg text-white hover:scale-105 transition-all duration-300"
        >
          forgot password
        </Link>
      </section>
