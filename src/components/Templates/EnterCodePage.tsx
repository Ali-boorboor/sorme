...
const EnterCodePage = memo(({ title }: any) => {
  return (
    <form
      className="bg-primary-color pt-8 py-4 px-6 rounded-2xl flex flex-col gap-4 max-w-md m-auto w-full h-96"
    ...
    >
      <section className="relative flex justify-between items-center">
        ...
        />
        <h1 className="font-semibold text-white text-2xl pl-2">{title}</h1>
        <img
